...
+-- components/ # presentational components
    +-- <%= presentationalComponentName %> # component that is only used in the package
...
```js
import <%= containerName %>, { actions, actionTypes, middleware, reducer } from '@bufferapp/<%= packageName %>';
```
...
#### components/<%= presentationalComponentName %>/index.jsx
...
#### components/<%= presentationalComponentName %>/story.jsx
